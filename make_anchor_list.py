...
def parse_arguments(argv):
    ...
    parser.add_argument('--in_hw', type=int, help='net work input image size', default=(192,256), nargs='+')
    parser.add_argument('--out_hw', type=int, help='net work output image size', default=(6,8,12,16), nargs='+')
